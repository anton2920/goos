...
BuildPackage	"internal/goos" "src/internal/goos/bare.go"
...
BuildPackageASM	"runtime" "src/runtime/defs.go src/runtime/lock.go src/runtime/mem.go src/runtime/os.go src/runtime/retry.go src/runtime/sigaction.go src/runtime/signal.go src/runtime/vdso.go $GOROOT/src/runtime/alg.go $GOROOT/src/runtime/arena.go $GOROOT/src/runtime/asan0.go $GOROOT/src/runtime/atomic_pointer.go $GOROOT/src/runtime/cgo.go $GOROOT/src/runtime/cgo_mmap.go $GOROOT/src/runtime/cgocall.go $GOROOT/src/runtime/cgocallback.go $GOROOT/src/runtime/cgocheck.go $GOROOT/src/runtime/chan.go $GOROOT/src/runtime/checkptr.go $GOROOT/src/runtime/compiler.go $GOROOT/src/runtime/complex.go $GOROOT/src/runtime/covercounter.go $GOROOT/src/runtime/covermeta.go $GOROOT/src/runtime/cpuflags.go $GOROOT/src/runtime/cpuflags_amd64.go $GOROOT/src/runtime/cpuprof.go $GOROOT/src/runtime/cputicks.go $GOROOT/src/runtime/create_file_nounix.go $GOROOT/src/runtime/debug.go $GOROOT/src/runtime/debugcall.go $GOROOT/src/runtime/debuglog.go $GOROOT/src/runtime/debuglog_off.go $GOROOT/src/runtime/env_posix.go $GOROOT/src/runtime/error.go $GOROOT/src/runtime/exithook.go $GOROOT/src/runtime/extern.go $GOROOT/src/runtime/fastlog2.go $GOROOT/src/runtime/fastlog2table.go $GOROOT/src/runtime/float.go $GOROOT/src/runtime/hash64.go $GOROOT/src/runtime/heapdump.go $GOROOT/src/runtime/histogram.go $GOROOT/src/runtime/iface.go $GOROOT/src/runtime/lfstack.go $GOROOT/src/runtime/lockrank.go $GOROOT/src/runtime/lockrank_off.go $GOROOT/src/runtime/malloc.go $GOROOT/src/runtime/map.go $GOROOT/src/runtime/map_fast32.go $GOROOT/src/runtime/map_fast64.go $GOROOT/src/runtime/map_faststr.go $GOROOT/src/runtime/mbarrier.go $GOROOT/src/runtime/mbitmap.go $GOROOT/src/runtime/mcache.go $GOROOT/src/runtime/mcentral.go $GOROOT/src/runtime/mcheckmark.go $GOROOT/src/runtime/mem.go $GOROOT/src/runtime/metrics.go $GOROOT/src/runtime/mfinal.go $GOROOT/src/runtime/mfixalloc.go $GOROOT/src/runtime/mgc.go $GOROOT/src/runtime/mgclimit.go $GOROOT/src/runtime/mgcmark.go $GOROOT/src/runtime/mgcpacer.go $GOROOT/src/runtime/mgcscavenge.go $GOROOT/src/runtime/mgcstack.go $GOROOT/src/runtime/mgcsweep.go $GOROOT/src/runtime/mgcwork.go $GOROOT/src/runtime/mheap.go $GOROOT/src/runtime/minmax.go $GOROOT/src/runtime/mpagealloc.go $GOROOT/src/runtime/mpagealloc_64bit.go $GOROOT/src/runtime/mpagecache.go $GOROOT/src/runtime/mpallocbits.go $GOROOT/src/runtime/mprof.go $GOROOT/src/runtime/mranges.go $GOROOT/src/runtime/msan0.go $GOROOT/src/runtime/msize.go $GOROOT/src/runtime/mspanset.go $GOROOT/src/runtime/mstats.go $GOROOT/src/runtime/mwbbuf.go $GOROOT/src/runtime/netpoll.go $GOROOT/src/runtime/netpoll_fake.go $GOROOT/src/runtime/nonwindows_stub.go $GOROOT/src/runtime/os_nonopenbsd.go $GOROOT/src/runtime/pagetrace_off.go $GOROOT/src/runtime/panic.go $GOROOT/src/runtime/pinner.go $GOROOT/src/runtime/plugin.go $GOROOT/src/runtime/preempt.go $GOROOT/src/runtime/preempt_nonwindows.go $GOROOT/src/runtime/print.go $GOROOT/src/runtime/proc.go $GOROOT/src/runtime/profbuf.go $GOROOT/src/runtime/proflabel.go $GOROOT/src/runtime/race0.go $GOROOT/src/runtime/rdebug.go $GOROOT/src/runtime/runtime.go $GOROOT/src/runtime/runtime1.go $GOROOT/src/runtime/runtime2.go $GOROOT/src/runtime/runtime_boring.go $GOROOT/src/runtime/rwmutex.go $GOROOT/src/runtime/security_nonunix.go $GOROOT/src/runtime/select.go $GOROOT/src/runtime/sema.go $GOROOT/src/runtime/sigqueue.go $GOROOT/src/runtime/sigqueue_note.go $GOROOT/src/runtime/sizeclasses.go $GOROOT/src/runtime/slice.go $GOROOT/src/runtime/softfloat64.go $GOROOT/src/runtime/stack.go $GOROOT/src/runtime/stkframe.go $GOROOT/src/runtime/string.go $GOROOT/src/runtime/stubs.go $GOROOT/src/runtime/stubs2.go $GOROOT/src/runtime/stubs_amd64.go $GOROOT/src/runtime/stubs_nonlinux.go $GOROOT/src/runtime/symtab.go $GOROOT/src/runtime/symtabinl.go $GOROOT/src/runtime/sys_nonppc64x.go $GOROOT/src/runtime/sys_x86.go $GOROOT/src/runtime/tagptr.go $GOROOT/src/runtime/tagptr_64bit.go $GOROOT/src/runtime/time.go $GOROOT/src/runtime/time_nofake.go $GOROOT/src/runtime/timestub.go $GOROOT/src/runtime/tls_stub.go $GOROOT/src/runtime/trace.go $GOROOT/src/runtime/traceback.go $GOROOT/src/runtime/type.go $GOROOT/src/runtime/typekind.go $GOROOT/src/runtime/unsafe.go $GOROOT/src/runtime/utf8.go $GOROOT/src/runtime/vdso_in_none.go $GOROOT/src/runtime/write_err.go" "src/runtime/rt0.s src/runtime/sys.s $GOROOT/src/runtime/asm.s $GOROOT/src/runtime/asm_amd64.s $GOROOT/src/runtime/duff_amd64.s $GOROOT/src/runtime/memclr_amd64.s $GOROOT/src/runtime/memmove_amd64.s $GOROOT/src/runtime/preempt_amd64.s" "-+" "-compiling-runtime"
